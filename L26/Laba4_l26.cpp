...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pSphereMesh->LoadMesh("C:/Users/acer/Downloads/box.obj")) {
            return false;
        }
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "C:/Users/acer/Downloads/normal_map.jpg");

        if (!m_pNormalMap->Load()) {
            return false;
        }

        m_pTrivialNormalMap = new Texture(GL_TEXTURE_2D, "C:/Users/acer/Downloads/normal_up.jpg");
