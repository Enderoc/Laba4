...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pQuad->LoadMesh("C:/Users/acer/Downloads/quad.obj")) {
            return false;
        }

        m_pGroundTex = new Texture(GL_TEXTURE_2D, "C:/Users/acer/Downloads/brick.png");
        ...
        return m_pMesh->LoadMesh("C:/Users/acer/Downloads/phoenix_ugv.md2");
    }
